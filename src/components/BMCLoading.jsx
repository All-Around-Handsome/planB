...
function BMCLoading({
  title = "BMC를 생성하는 중입니다",
  desc = "입력한 아이디어를 바탕으로 비즈니스 모델 캔버스를 구성하고 있습니다.",
  duration = 3000,
  onComplete,
}) {
      ...
      <div className="w-full max-w-[620px] bg-white border border-blue-100 rounded-[28px] px-10 py-10 shadow-[0_16px_40px_rgba(37,99,235,0.08)]">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-3xl font-bold text-gray-900 mb-4">
            {roundedProgress >= 100 ? "BMC 생성이 완료되었습니다" : title}
          </h3>
